...
class User extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'status' => UserModule::t("Status"),
                        'free_listing'=>UserModule::t("Free Listing")
		);
	}
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, username, password, email, activkey, createtime, lastvisit, superuser, status,free_listing',
            ),
        );
    }
    ...
    {
        return array(
            'select' => 'id, username, email, createtime, lastvisit, superuser, status, free_listing',
        );
    }
